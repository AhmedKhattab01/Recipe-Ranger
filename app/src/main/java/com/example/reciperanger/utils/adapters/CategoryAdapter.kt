...
import com.example.reciperanger.utils.differs.CategoryDiffItemCallBack
        ...
        fun bind(item: Category) {
            ...
            binding.root.setOnClickListener {
                it.findNavController().navigate(
                    HomeFragmentDirections.actionHomeFragmentToCategorizedMealsFragment(item.strCategory)
                )
            }
        }
    }
